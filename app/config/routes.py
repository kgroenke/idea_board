...
routes['/'] = 'Users#login'
routes['/bright_ideas'] = 'Users#index'
...
routes['/bright_ideas/<id>'] = 'Users#show_idea'
routes['POST']['/delete/comment/<id>'] = 'Users#delete_comment'
routes['POST']['/delete/<id>'] = 'Users#delete'
routes['POST']['/comment/<id>'] = 'Users#comment'
routes['POST']['/update/<id>'] = 'Users#update'
routes['POST']['/edit/<id>'] = 'Users#edit'
"""
